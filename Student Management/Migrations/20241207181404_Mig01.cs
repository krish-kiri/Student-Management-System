        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentRoleUserViewModelId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    StudentRoleUserViewModelId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.StudentRoleUserViewModelId,
                        principalTable: "Students",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Subjects_Students_StudentRoleUserViewModelId1",
                        column: x => x.StudentRoleUserViewModelId1,
                        principalTable: "Students",
                        principalColumn: "Id");
                });
